...
import edu.nuce.cinema.ui.login.LoginFragmentDirections.Companion.actionLoginToHome
...
class LoginFragment : BaseFragment(R.layout.fragment_login), View.OnClickListener,
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        _binding.tvGoHome.setOnClickListener(this)
    }
    ...
    override fun onClick(view: View?) {
        when (view?.id) {
            ...
            R.id.tv_go_home -> findNavController().navigate(actionLoginToHome())
        }
    }
...
//                        }
    ...
    private fun updateUI(account: GoogleSignInAccount?) {
        account?.let {
            _getDefaultOAuthCredentials.onNext(
                LoginIntent.LoginWithGoogleIntent(
                    Login(
                        it.email.toString(),
    ...
    override fun render(state: LoginViewState) {
        ...
        state.oAuthCredentials?.let {
            oAuthManager.saveCredentials(state.oAuthCredentials)
            findNavController().navigate(actionLoginToHome())
        }
