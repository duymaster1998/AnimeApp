...
sealed class NetworkState {
    ...
    data class NoResponse(val exception: ApiException) : NetworkState()
    data class BadRequest(val exception: ApiException) : NetworkState()
    object Unauthorized : NetworkState()
    data class RequestTimeout(val exception: ApiException) : NetworkState()
}
